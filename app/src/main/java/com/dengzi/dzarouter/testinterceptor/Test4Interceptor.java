...
import com.dengzi.dzarouter.MainActivity;
...
public class Test4Interceptor implements IInterceptor {
    Context mContext;
    ...
    public void init(Context context) {
        mContext = context;
        Log.e("testService", Test4Interceptor.class.getName() + " has init.");
    }
}
